...
{
  private function kiemTraTonKho($gioHangChiTietIds)
  {
    foreach ($gioHangChiTietIds as $id) {
      ...
      if ($sanPhamChiTiet->so_luong_ton < $gio_hang_chi_tiet->so_luong) {
  ...
  private function taoDonHang(array $id_gio_hang_chi_tiet)
  {
  ...
  private function xuLySauThanhToanThatBai(int $id_don_hang)
  {
